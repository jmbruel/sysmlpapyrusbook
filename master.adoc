...
(Fork me on https://github.com/jmbruel/sysmlpapyrusbook[icon:github[] GitHub] -- Also available in http://jmbruel.github.io/sysmlpapyrusbook/PapyrusSysMLinAction.pdf[PDF])
endif::backend-pdf[]
