...
WARNING: Pour la version `1.6` pour l'instant l'_update site_ est ici : https://hudson.eclipse.org/papyrus/job/papyrus-sysml16-master/lastSuccessfulBuild/artifact/releng/org.eclipse.papyrus.sysml16.p2/target/repository/
