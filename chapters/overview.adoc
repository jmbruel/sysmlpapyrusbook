...
nous utiliserons le <<ibd,diagramme de blocs internes>>.
Le <<param,diagramme paramétrique>> n'est qu'un diagramme de blocs internes dédié aux relations entre valeurs
...
image::{diagrams}/table.png[width=70%,scaledwidth=70%]
...
.Exemple de diagramme de blocks
image::todo.jpg[]
...
=====
// Sebastien
Nous avons parlé du diagramme de contexte dans la section précédente sur le diagramme de block.
...
Le diagramme de séquence est un diagramme populaire pour représenter les
