...
image::dessins/state.png[width=40%,scaledwidth=80%]
...
+
.Etat initial
image::dessins/initState.png[width=20%,scaledwidth=20%]
- l’état final du diagramme d’états correspond à la destruction de l’instance.
+
.Etat final
image::dessins/finalState.png[width=20%,scaledwidth=20%]
