...
:FichierExigences: https://docs.google.com/spreadsheets/d/1i-zIZV0Mel5tY0e0op2l-pQHbrX4BoqF8FZbHqHeyR8/edit#gid=0
...
[WARNING]
====
Cette liste contient des exigences de différentes sortes :

- des contraintes
- des besoins utilisateurs
- des exigences de très haut niveau (métier)
- des exigences techniques

Elles respectent la définition canonique d'une exigence :
[quote,http://specief.org]
____
"Une exigence est l’expression d’une condition ou d’une fonctionnalité à laquelle doit répondre un système ou un logiciel."
____

Néanmoins, à ce stade, peu peuvent être directement utilisée car, par exemple,
elles ne sont pas mesurables (et donc pas vérifiables), ce qui est une caractéristique
cruciale pour une exigence.
Nous avons volontairement décrit les exigences initiales sous cette forme pour
permettre d'illustrer le support de {sysml} en terme de raffinement d'exigences.
====
...
WARNING: JMB => Traduire en scénario
