...
image::SysML-PRFC.svg[width=40%,align=center]
>>>>>>> 2d44ff79ac7f45d36b06c5e10b8fb51cbc8916c2
...
{Behavior}::
Le comportement d'un système est du point de vue de l'utilisateur final beaucoup plus important que la structure elle-même. C'est la partiequ'il est la plus à même d'exprimer, de comprendre (vos modèles) et de valider.
...
Nous commençons par les exigences (chapitre <<RE>>).
