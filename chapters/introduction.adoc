...
Nous allons aborder <<methods,en fin de ce chapitre>> les processus connus et courants en Ingénierie Système (IS) généralement associés à {SysML}.
...
=== Différeferences entre modèle et dessin
...
Nous renvoyons pour cela le lecteur aux grands classiques ([red]#xxx,yyy#).
